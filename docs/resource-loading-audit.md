...
| 卫星贴图 | 进入对应父行星系统或聚焦卫星时按需加载 | 固定最高画质；仍保持按需加载，避免首屏一次性加载全部卫星贴图 |
...
| `textures/solar-system-scope/2k_earth_clouds.jpg` | 0.92 MB | 地球云层 | 首屏 | 中优先级：固定最高画质下保留当前云层资源 |
