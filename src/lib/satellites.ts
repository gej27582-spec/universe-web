...
export const SATELLITES: Satellite[] = [
  {
    ...
    phenomenonLabel: '地球反照光', phenomenonDescription: '近景暗面保留一层冷蓝反照光，并以增强的昼夜分界线突出月面起伏。',
  ...
  },
  {
    ...
    phenomenonLabel: '碎岩轮廓', phenomenonDescription: '非球形低多边形表面与缓慢翻滚强调它被撞击塑造的破碎轮廓。',
    phenomenon: 'irregular', color: 0x81786b,
  ...
  },
  {
    ...
    phenomenonLabel: '低重力漂移', phenomenonDescription: '较慢的轨道运动、柔和边缘光和轻微轴向摆动表现低重力小天体。',
    phenomenon: 'irregular', color: 0x9a9080,
  ...
  },
  {
    ...
    phenomenonLabel: '火山辉光', phenomenonDescription: '一层克制的琥珀色脉冲从向光侧溢出，提示持续活跃的火山世界。',
  ...
  {
    id: 'europa', parentId: 'jupiter', nameZh: '木卫二', nameEn: 'EUROPA', diameter: '3,122 km', diameterKm: 3121.6,
    orbitalDistance: '距木星 671,100 km', orbitalDistanceKm: 671100,
    description: '冰壳下方可能存在全球性液态海洋，是重要的生命候选世界。',
    phenomenonLabel: '冰壳高光', phenomenonDescription: '清漆般的窄幅高光掠过冰面，强化裂纹覆盖的光滑冰壳。',
  ...
  },
  {
    ...
    description: '太阳系最大的卫星，也是已知唯一拥有自身磁场的卫星。',
    phenomenonLabel: '磁层边缘', phenomenonDescription: '非常微弱的青色边缘层提示这颗卫星拥有独立磁场，而不遮盖真实表面。',
  ...
  },
  {
    ...
    phenomenonLabel: '古老撞击面', phenomenonDescription: '高粗糙度材质保留暗部层次，让密集撞击结构在掠射光下更易辨认。',
  ...
  },
  {
    ...
    phenomenonLabel: '甲烷雾霾', phenomenonDescription: '双层橙金色大气壳随视角形成柔和轮缘，表面只在近景中若隐若现。',
  ...
  },
  {
    ...
    phenomenonLabel: '南极喷流', phenomenonDescription: '从南极区域释放的低密度冰晶粒子形成短促扇形喷流，并在减少动态效果时静止。',
  ...
  },
  {
    ...
    phenomenonLabel: '逆行冰霜', phenomenonDescription: '淡粉与冷蓝冰面沿反方向运行，轨道刻度明确标出 RETROGRADE 逆行状态。',
